...
def download(c: Context):
    ...
    url = "https://github.com/mstorsjo/llvm-mingw/releases/download/20230517/llvm-mingw-20230517-ucrt-ubuntu-20.04-x86_64.tar.xz"
    dest = c.path("{{ tmp }}/tars/llvm-mingw-20230517-ucrt-ubuntu-20.04-x86_64.tar.xz")
...
def unpack(c: Context):
    ...
    c.run("tar xaf {{ tmp }}/tars/llvm-mingw-20230517-ucrt-ubuntu-20.04-x86_64.tar.xz")
    c.run("ln -s llvm-mingw-20230517-ucrt-ubuntu-20.04-x86_64 llvm-mingw")
